...
clean Sherwood checkout and consumes one exact TRX result containing the six
...
| Owner isolation for operations, receipts, private evidence, export, deletion and audit               | Missing               | Public privacy schemas and offline verifier exist, but the process lifecycle and transport evidence are not consumed by this harness yet.                                                                                                                                                   |
