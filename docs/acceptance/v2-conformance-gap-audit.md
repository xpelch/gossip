...
| Independent vector verification                                                                      | Proven offline        | Canonical, evidence, receipt, HTTP auth, identity-session, privacy, public-submission and manifest verifiers run from the installed artifact.                                                                                                               |
