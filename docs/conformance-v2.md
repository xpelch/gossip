...
```powershell
node scripts/run-v2-conformance.mjs --output C:\temp\gossip-v2-acceptance --sherwood-repository C:\src\sherwood --sherwood-commit 0752939896b2f7b97d51767d4b6206329d76e14e
```
